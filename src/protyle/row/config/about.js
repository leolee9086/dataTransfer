...
<div class="b3-label">
    ...
    bindEvent: () => {
        ...
        const workspaceDirElement = about.element.querySelector("#workspaceDir");
        workspaceDirElement.addEventListener("change", () => __awaiter(void 0, void 0, void 0, function* () {
            let workspace = workspaceDirElement.value;
            if (workspaceDirElement.value === "0") {
                const localPath = yield dialog.showOpenDialog({
    ...
    <button class="b3-button b3-button--text">${window.siyuan.languages.confirm}</button>
        ...
        about.element.querySelector("#aboutConfim").addEventListener("click", () => {
            fetchPost("/api/system/setNetworkProxy", {
                scheme: about.element.querySelector("#aboutScheme").value,
                host: about.element.querySelector("#aboutHost").value,
                port: about.element.querySelector("#aboutPort").value
            }, () => {
                exportLayout(false, () => {
                    exitSiYuan();
                });
