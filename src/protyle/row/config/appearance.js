...
<label class="fn__flex b3-label">
    ...
    <span class="ft__on-surface fn__flex-center">${window.siyuan.languages[subItem]}</span>
        ...
        const pickrs = {};
        appearance.element.querySelectorAll("#appearanceCustomPanel .colorPicker").forEach((item) => {
            // @ts-ignore
    ...
    _send: (mode) => {
        ...
        const modeNumber = typeof mode === "number" ? mode : parseInt(appearance.element.querySelector("#mode").value);
