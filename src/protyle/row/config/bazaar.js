...
<div id="configBazaarReadme" class="config-bazaar__readme"></div>
    ...
    <div class="fn__hr--b"></div>
    <div class="fn__hr--b"></div>
    <div class="${data.installed ? "fn__none" : ""}" data-type="${(_a = data.modes) === null || _a === void 0 ? void 0 : _a.toString()}">
...
<div class="item__main">
            ...
            while (target && !target.isEqualNode(bazaar.element)) {
                ...
                if (type === "goBack") {
                    ...
                    if (!target.classList.contains("b3-button--progress")) {
                        const bazaarType = target.getAttribute("data-bazaar");
                    ...
                    confirmDialog(window.siyuan.languages.update, window.siyuan.languages.exportTplTip, () => {
                        ...
                        let bazaarType = "themes";
                        if (cardElement) {
                            bazaarType = cardElement.getAttribute("data-bazaar");
                        }
                        let url = "/api/bazaar/installBazaarTemplate";
                        if (bazaarType === "themes") {
                            url = "/api/bazaar/installBazaarTheme";
                    ...
                    bazaar.renderReadme(target, target.getAttribute("data-bazaar"));
                    event.preventDefault();
                    event.stopPropagation();
                    break;
                }
    ...
    onBazaar(response, bazaarType, reload) {
