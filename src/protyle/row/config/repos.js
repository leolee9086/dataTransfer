...
const renderCloudBackup = () => {
    ...
    <span class="b3-list-item__meta fn__flex-center">${(_a = response.data.backup) === null || _a === void 0 ? void 0 : _a.updated}</span>
    <div class="fn__flex-1"></div>
...
<div class="fn__none">
    ...
    <div class="fn__flex-center">${window.siyuan.languages.cloudBackup}</div>
    <span class="b3-list-item__meta fn__flex-center">${(_b = response.data.backup) === null || _b === void 0 ? void 0 : _b.updated}</span>
    <div class="fn__flex-1"></div>
