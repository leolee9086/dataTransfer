...
export const kernelError = () => {
    var _a, _b;
    let iosReStart = "";
    if (window.siyuan.config.system.container === "ios" && ((_a = window.webkit) === null || _a === void 0 ? void 0 : _a.messageHandlers)) {
...
<div class="b3-dialog__container">
    ...
    if (restartElement && ((_b = window.webkit) === null || _b === void 0 ? void 0 : _b.messageHandlers)) {
            ...
            if (buttonElement) {
                buttonElement.addEventListener("click", () => {
                    fetchPost("/api/system/exit", { force: true }, () => {
                        ...
                        /// #else
                        if (["ios", "android"].includes(window.siyuan.config.system.container) && (((_a = window.webkit) === null || _a === void 0 ? void 0 : _a.messageHandlers) || window.JSAndroid)) {
...
export const downloadProgress = (data) => {
    ...
    const btnElement = bazzarElement.querySelector(`[data-url="${data.id}"]`);
    if (btnElement) {
        if (data.percent >= 1) {
