...
const openFile = (options) => {
    ...
    if (options.assetPath) {
        ...
        if (editor) {
            ...
            if ((!nodeElement || (nodeElement === null || nodeElement === void 0 ? void 0 : nodeElement.clientHeight) === 0) && options.id !== options.rootID) {
        ...
        if (options.position === "right" && wnd.children[0].model) {
            ...
            if (wnd.parent.children.length > 1 && wnd.parent instanceof Layout && wnd.parent.direction === "lr") {
                wnd.parent.children.find((item, index) => {
                    if (item.id === wnd.id) {
                        targetWnd = wnd.parent.children[index + 1];
                        return true;
                    }
                });
            }
...
export const updatePanelByEditor = (protyle, focus = true, pushBackStack = false, reload = false) => {
    ...
    if (protyle && protyle.path) {
        ...
        if (window.siyuan.config.fileTree.alwaysSelectOpenedFile && protyle) {
            const fileModel = (_a = getDockByType("file")) === null || _a === void 0 ? void 0 : _a.data.file;
...
const updateOutline = (models, protyle, reload = false) => {
    models.outline.find(item => {
        var _a;
        if (reload || (item.type === "pin" && (!protyle || item.blockId !== ((_a = protyle.block) === null || _a === void 0 ? void 0 : _a.rootID)))) {
            let blockId = "";
...
export const updateBacklinkGraph = (models, protyle) => {
    ...
    models.graph.forEach(item => {
        var _a, _b;
        if (item.type !== "global" && (!protyle || item.blockId !== ((_a = protyle.block) === null || _a === void 0 ? void 0 : _a.id))) {
            if (item.type === "local" && item.rootId !== ((_b = protyle === null || protyle === void 0 ? void 0 : protyle.block) === null || _b === void 0 ? void 0 : _b.rootID)) {
                return;
            }
            let blockId = "";
            if (protyle && protyle.block) {
    ...
    models.backlinks.forEach(item => {
        var _a;
        if (item.type === "local" && item.rootId !== ((_a = protyle === null || protyle === void 0 ? void 0 : protyle.block) === null || _a === void 0 ? void 0 : _a.rootID)) {
            return;
        }
        let blockId = "";
        if (protyle && protyle.block) {
