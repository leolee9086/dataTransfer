...
<div class="fn__flex">
    ...
    inputElement.addEventListener("compositionend", () => {
        ...
        (_a = window.siyuan.menus.menu.element.firstElementChild.querySelector(".emojis__item")) === null || _a === void 0 ? void 0 : _a.classList.add("emojis__item--current");
        if (inputElement.value === "") {
    ...
    inputElement.addEventListener("keydown", (event) => {
        ...
        if (event.key === "ArrowLeft" || event.key === "ArrowUp") {
            ...
            else if ((_a = currentElement.parentElement.previousElementSibling) === null || _a === void 0 ? void 0 : _a.previousElementSibling) {
                currentElement.classList.remove("emojis__item--current");
            ...
            else if ((_b = currentElement.parentElement.nextElementSibling) === null || _b === void 0 ? void 0 : _b.nextElementSibling) {
                currentElement.classList.remove("emojis__item--current");
...
export const updateOutlineEmoji = (unicode) => {
    if (isMobile()) {
        return;
    }
...
export const updateFileTreeEmoji = (unicode, id, icon = "iconFile") => {
    ...
    if (isMobile()) {
        ...
        const files = getDockByType("file").data.file;
        if (icon === "iconFile") {
...
const updateFileEmoji = (unicode, id) => {
    if (isMobile()) {
