...
import { getInstanceById, getWndByLayout, newCenterEmptyTab, resizeTabs, setPanelFocus, switchWnd } from "./util";
...
export class Wnd {
    constructor(resize, parentType) {
        this.children = [];
        this.removeTabAction = (id, closeAll = false) => {
    ...
    <div class="layout-tab-container fn__flex-1">${dragHTML}</div>
        ...
        this.headersElement.addEventListener("dragover", function (event) {
            ...
            let exitDrag = false;
            Array.from(it.childNodes).find((item) => {
        ...
        this.headersElement.addEventListener("drop", function (event) {
            var _a;
            const oldTab = getInstanceById(event.dataTransfer.getData(Constants.SIYUAN_DROP_TAB));
            const it = this;
            it.classList.remove("layout-tab-bar--drag");
            const nextTabHeaderElement = (_a = Array.from(it.childNodes).find((item) => {
                if (item.style.opacity === "0.1") {
                    return true;
                }
            })) === null || _a === void 0 ? void 0 : _a.nextElementSibling;
            if (!it.contains(oldTab.headElement)) {
                ...
                // 对象顺序
                const newWnd = getInstanceById(it.parentElement.getAttribute("data-id"));
        ...
        dragElement.addEventListener("drop", (event) => {
            ...
            const oldTab = getInstanceById(tabId);
        ...
        this.children.forEach((item) => {
            ...
            if (target === item.headElement) {
                if (item.headElement && item.headElement.classList.contains("fn__none")) {
                    ...
                    (_a = item.headElement) === null || _a === void 0 ? void 0 : _a.classList.add("item--focus");
                    item.panelElement.classList.remove("fn__none");
                }
                currentTab = item;
            }
            else {
                (_b = item.headElement) === null || _b === void 0 ? void 0 : _b.classList.remove("item--focus");
    ...
    addTab(tab, keepCursor = false) {
        var _a;
        if (keepCursor) {
            (_a = tab.headElement) === null || _a === void 0 ? void 0 : _a.classList.remove("item--focus");
        ...
        this.children.forEach((item, index) => {
            ...
            if (!keepCursor) {
                (_a = item.headElement) === null || _a === void 0 ? void 0 : _a.classList.remove("item--focus");
                item.panelElement.classList.add("fn__none");
            }
        });
    ...
    removeTab(id, closeAll = false) {
        var _a;
        for (let index = 0; index < this.children.length; index++) {
            const item = this.children[index];
            if (item.id === id) {
                if ((item.model instanceof Editor) && ((_a = item.model.editor) === null || _a === void 0 ? void 0 : _a.protyle)) {
