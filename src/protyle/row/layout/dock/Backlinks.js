                ...
                if (data) {
                    switch (data.cmd) {
                        ...
                        case "unmount":
                            ...
                            break;
                        case "remove":
                            if (((_a = this.path) === null || _a === void 0 ? void 0 : _a.indexOf(getDisplayName(data.data.path, false, true))) === 0 && this.type === "local") {
                                this.parent.parent.removeTab(this.parent.id);
                            }
                            break;
                    }
...
<div class="backlinkMList fn__flex-1"></div>`;
    ...
    searchBacklinks(beforeLength, ignoreClass = false) {
