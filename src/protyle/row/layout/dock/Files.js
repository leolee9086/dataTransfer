...
<ul class="b3-list fn__flex-column" style="min-height: auto;transition: var(--b3-transition)">
    ...
    <ul class="fn__none fn__flex-1"></ul>
        ...
        this.closeElement.addEventListener("click", (event) => {
            ...
            while (target && !target.isEqualNode(this.closeElement)) {
                ...
                if (target.classList.contains("b3-list-item__icon")) {
                    ...
                    confirmDialog(window.siyuan.languages.delete, `${window.siyuan.languages.confirmDelete} <b>${escapeHtml(target.parentElement.querySelector(".b3-list-item__text").textContent)}</b>?`, () => {
        ...
        this.element.addEventListener("dragover", (event) => {
            ...
            if ((_a = window.siyuan.dragElement.parentElement) === null || _a === void 0 ? void 0 : _a.classList.contains("protyle-gutters")) {
        ...
        this.element.addEventListener("drop", (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (newElement.classList.contains("dragover")) {
                yield fetchPost("/api/filetree/moveDoc", {
...
<li class="b3-list-item b3-list-item--hide-action" draggable="true" data-type="navigation-root" data-path="/">
    ...
    onRemove(data) {
        ...
        if (data.cmd === "unmount") {
            ...
            // 子节点展开则删除
            if (((_a = targetElement.nextElementSibling) === null || _a === void 0 ? void 0 : _a.tagName) === "UL") {
                targetElement.nextElementSibling.remove();
            }
            // 移除当前节点
    ...
    onMount(data) {
        ...
        setNoteBook((notebooks) => {
            ...
            if (data.callback === Constants.CB_MOUNT_HELP) {
                openFileById({
                    id: Constants.HELP_START_PATH[window.siyuan.config.appearance.lang],
                    action: [Constants.CB_GET_FOCUS]
                });
            }
        });
    ...
    getLeaf(liElement, notebookId) {
        ...
        if (toggleElement.classList.contains("b3-list-item__arrow--open")) {
            toggleElement.classList.remove("b3-list-item__arrow--open");
            (_a = liElement.nextElementSibling) === null || _a === void 0 ? void 0 : _a.remove();
            return;
        }
        fetchPost("/api/filetree/listDocsByPath", {
            notebook: notebookId,
