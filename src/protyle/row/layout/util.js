...
const JSONToDock = (json) => {
    window.siyuan.layout.centerLayout = window.siyuan.layout.layout.children[1].children[1];
...
const JSONToCenter = (json, layout) => {
    let child;
...
export const addResize = (obj) => {
    if (obj.resize) {
        const resizeWnd = (resizeElement, direction) => {
            ...
            resizeElement.addEventListener("mousedown", (event) => {
                ...
                documentSelf.onmouseup = () => {
                    ...
                    else if (((_a = nextElement.nextElementSibling) === null || _a === void 0 ? void 0 : _a.nextElementSibling) &&
        ...
        resizeElement.previousElementSibling.style.transition = "var(--b3-width-transition)";
