...
export const copySubMenu = (id, name, accelerator = true, focusElement) => {
    return [
        {
            icon: "iconGraph",
...
export const openMenu = (src, onlyMenu = false) => {
    const submenu = [];
    if (isLocalPath(src)) {
        submenu.push({
...
export const newFileMenu = (notebookId, path, open) => {
    return new MenuItem({
        icon: "iconFile",
...
export const deleteMenu = (notebookId, name, pathString) => {
    return new MenuItem({
        icon: "iconTrashcan",
...
export const movePathToMenu = (notebookId, path) => {
    return new MenuItem({
