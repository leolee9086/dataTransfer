...
import { copySubMenu, deleteMenu, exportMd, movePathToMenu, newFileMenu, openFileAttr, renameMenu, } from "./commonMenuItem";
/// #if !BROWSER
...
export const initNavigationMenu = (liElement) => {
    ...
    if (!window.siyuan.config.readonly) {
        ...
        window.siyuan.menus.menu.append(new MenuItem({
            ...
            accelerator: "⌦",
            click: () => {
                confirmDialog(window.siyuan.languages.delete, `${window.siyuan.languages.confirmDelete} <b>${Lute.EscapeHTMLStr(name)}</b>?`, () => {
...
export const initFileMenu = (notebookId, pathString, id, name) => {
    window.siyuan.menus.menu.remove();
        ...
        const importstdmd = (label, isDoc) => {
            return {
                ...
                click: () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const localPath = yield remoteDialog.showOpenDialog({
