    ...
    window.siyuan.menus.menu.append(new MenuItem({
        ...
        click() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    // * _ [ ] ! \ ` < > & ~ { } ( ) = # $ ^ |
                    let clipText = yield navigator.clipboard.readText();
...
export const zoomOut = (protyle, id, focusId, isPushBack = true) => {
    ...
    window.siyuan.menus.menu.append(new MenuItem({
        ...
        bind(element) {
            ...
            inputElement.addEventListener("change", (event) => {
                imgElement.setAttribute("alt", event.target.value);
                nodeElement.setAttribute("updated", dayjs().format("YYYYMMDDHHmmss"));
                updateTransaction(protyle, id, nodeElement.outerHTML, html);
                html = nodeElement.outerHTML;
            });
...
export const linkMenu = (protyle, linkElement, focusText = false) => {
    ...
    if (linkAddress === null || linkAddress === void 0 ? void 0 : linkAddress.startsWith("siyuan://blocks/")) {
        window.siyuan.menus.menu.append(new MenuItem({
            icon: "iconRefresh",
            ...
            click() {
                ...
                linkElement.setAttribute("data-id", linkAddress === null || linkAddress === void 0 ? void 0 : linkAddress.replace("siyuan://blocks/", ""));
...
export const iframeMenu = (protyle, nodeElement) => {
    ...
    return subMenus.concat(openMenu(iframeElement.getAttribute("src") || "", true));
};
export const videoMenu = (protyle, nodeElement, type) => {
    ...
    return subMenus.concat(openMenu(videoElement.getAttribute("src"), true));
};
export const tableMenu = (protyle, nodeElement, cellElement, range) => {
    ...
    if (!nextRowElement && cellElement.parentElement.parentElement.tagName === "THEAD") {
        nextRowElement = (_a = tableElement.querySelector("tbody")) === null || _a === void 0 ? void 0 : _a.firstElementChild;
    }
    if (nextRowElement) {
