    ...
    showMenu(protyle, position) {
        ...
        fetchPost("/api/block/getBlockWordCount", { id: id || protyle.block.id }, (response) => {
            ...
            if (!protyle.contentElement.classList.contains("fn__none")) {
                ...
                if (window.siyuan.config.system.container !== "android" || !window.JSAndroid) {
                    window.siyuan.menus.menu.append(new MenuItem({
                        ...
                        icon: "iconRecord",
                        label: ((_a = this.mediaRecorder) === null || _a === void 0 ? void 0 : _a.isRecording) ? window.siyuan.languages.endRecord : window.siyuan.languages.startRecord,
                        click: () => {
                            let messageId = "";
            ...
            window.siyuan.menus.menu.append(new MenuItem({
                ...
                click: () => {
                    var _a;
                    (_a = protyle.title) === null || _a === void 0 ? void 0 : _a.render(protyle, true);
                    fetchPost("/api/filetree/getDoc", {
