...
<div class="b3-dialog__action">
    ...
    <button class="b3-button b3-button--text">${window.siyuan.languages.confirm}</button>
        ...
        btnsElement[1].addEventListener("click", () => {
            const options = {
                printBackground: true,
                landscape: pdfDialog.element.querySelector("#landscape").checked,
                marginsType: parseInt(pdfDialog.element.querySelector("#marginsType").value),
                scaleFactor: parseInt(pdfDialog.element.querySelector("#scaleFactor").value),
                pageSize: pdfDialog.element.querySelector("#pageSize").value,
            };
            const removeAssets = pdfDialog.element.querySelector("#removeAssets").checked;
...
/// #if !BROWSER
const getExportPath = (option, pdfOption, removeAssets) => {
...
const onExport = (data, filePath, type, pdfOptions, removeAssets, msgId) => {
