...
export class Background {
    constructor(protyle) {
        this.transparentData = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=";
...
<div class="b3-dialog__action">
    ...
    render(ial, id) {
        ...
        if (img) {
            ...
            const url = (_a = this.imgElement.style.backgroundImage) === null || _a === void 0 ? void 0 : _a.replace(/^url\(["']?/, "").replace(/["']?\)$/, "");
