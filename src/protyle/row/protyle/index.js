...
class Protyle {
    ...
    constructor(id, options) {
        ...
        fetchPost("/api/filetree/getDoc", {
            ...
            size: ((_a = options.action) === null || _a === void 0 ? void 0 : _a.includes(Constants.CB_GET_ALL)) ? Constants.SIZE_GET_MAX : Constants.SIZE_GET,
        }, getResponse => {
            var _a;
            onGet(getResponse, this.protyle, options.action);
            if (this.protyle.model) {
                if ((_a = options.action) === null || _a === void 0 ? void 0 : _a.includes(Constants.CB_GET_FOCUS)) {
