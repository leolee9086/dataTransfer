    ...
    addScript(`${cdn}/js/highlight.js/highlight.min.js?v=11.5.0`, "protyleHljsScript").then(() => {
        addScript(`${cdn}/js/highlight.js/third-languages.js?v=1.0.0`, "protyleHljsThirdScript").then(() => {
            codeElements.forEach((block) => {
                ...
                else if ((_a = block.nextElementSibling) === null || _a === void 0 ? void 0 : _a.classList.contains("protyle-linenumber__rows")) {
...
export const lineNumberRender = (block) => {
    ...
    if ((_a = block.nextElementSibling) === null || _a === void 0 ? void 0 : _a.classList.contains("protyle-linenumber__rows")) {
