...
import { focusByRange, focusByWbr, focusSideBlock, getEditorRange, getSelectionOffset, getSelectionPosition, setFirstNodeRange, setLastNodeRange } from "../util/selection";
...
export class Toolbar {
    ...
    getCurrentType(range = this.range) {
        ...
        else if (startElement.childElementCount > 0 && ((_a = startElement.childNodes[range.startOffset]) === null || _a === void 0 ? void 0 : _a.nodeType) !== 3) {
        ...
        else if (endElement.childElementCount > 0 && ((_b = endElement.childNodes[range.endOffset]) === null || _b === void 0 ? void 0 : _b.nodeType) !== 3) {
        ...
        if (range.startOffset === range.startContainer.textContent.length) {
            ...
            if (nextSibling && nextSibling.nodeType !== 3 && nextSibling.getAttribute("data-type") === "inline-math") {
    ...
    pushNode(newNodes, element) {
        element.childNodes.forEach((item) => {
            if (item.nodeType !== 3 && ((item.getAttribute("data-type") === "inline-math" && item.textContent !== "") ||
    ...
    setInlineMark(protyle, type, action, focusAdd = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.range.toString() !== "" && tableElement && this.range.commonAncestorContainer.nodeType !== 3) {
                const parentTag = this.range.commonAncestorContainer.tagName;
            ...
            if ((action === "toolbar" && actionBtn.classList.contains("protyle-toolbar__item--current")) ||
                ...
                if (type === "inline-math") {
                    ...
                    if (startText + selectContents.textContent + endText === "") {
                        this.showRender(protyle, newElement);
                    }
                    else {
                        focusByRange(this.range);
                    }
                    ...
                    if (type === "link") {
                        ...
                        try {
                            ...
                            if (protyle.lute.IsValidLinkDest(this.range.toString().trim())) {
                                newElement.setAttribute("data-href", this.range.toString().trim());
                                needShowLink = false;
                            }
                            else if (protyle.lute.IsValidLinkDest(clipText)) {
                                newElement.setAttribute("data-href", clipText);
                        ...
                        if (needShowLink) {
                            linkMenu(protyle, newElement, focusText);
...
<div class="fn__flex"><span class="fn__flex-1"></span>
    ...
    showRender(protyle, renderElement) {
        var _a;
...
- baz`;
        ...
        const isPin = (_a = this.subElement.querySelector('[data-type="pin"]')) === null || _a === void 0 ? void 0 : _a.classList.contains("block__icon--active");
        const pinData = {};
        if (isPin) {
...
<textarea spellcheck="false" class="b3-text-field b3-text-field--text fn__block" placeholder="${placeholder}" style="width:${isMobile() ? "80vw" : Math.max(480, renderElement.clientWidth * 0.7) + "px"};max-height:50vh"></textarea></div>`;
        ...
        this.subElement.querySelector(".block__icons").addEventListener("click", (event) => {
            const target = event.target;
        ...
        this.subElement.querySelector(".block__icons").addEventListener("mousedown", (event) => {
        ...
        if (type === "NodeHTMLBlock") {
            ...
            const switchElement = this.subElement.querySelector(".b3-switch");
...
<div class="b3-list fn__flex-1 b3-list--background" style="position: relative">${html}</div>
    ...
    showFile(protyle, nodeElements, range) {
        this.range = range;
