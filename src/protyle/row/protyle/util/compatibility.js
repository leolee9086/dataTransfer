...
export const writeText = (text) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        ...
        if ("ios" === window.siyuan.config.system.container && ((_a = window.webkit) === null || _a === void 0 ? void 0 : _a.messageHandlers)) {
        ...
        if (window.siyuan.config.system.container === "ios" && ((_b = window.webkit) === null || _b === void 0 ? void 0 : _b.messageHandlers)) {
            window.webkit.messageHandlers.setClipboard.postMessage(text);
        }
