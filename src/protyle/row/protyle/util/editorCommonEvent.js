...
const dragSb = (protyle, sourceElements, targetElement, isBottom, direct) => {
    ...
    const undoOperations = [{
            ...
            previousID: (_a = targetElement.previousElementSibling) === null || _a === void 0 ? void 0 : _a.getAttribute("data-node-id"),
            parentID: ((_b = targetElement.parentElement) === null || _b === void 0 ? void 0 : _b.getAttribute("data-node-id")) || protyle.block.parentID
        }];
    ...
    const doOperations = [{
            ...
            previousID: (_c = sbElement.previousElementSibling) === null || _c === void 0 ? void 0 : _c.getAttribute("data-node-id"),
    ...
    if (newSourceElement) {
        ...
        if (isBottom) {
            ...
            doOperations.push({
                ...
                data: newSourceElement.outerHTML,
                id: newSourceElement.getAttribute("data-node-id"),
                previousID: (_d = newSourceElement.previousElementSibling) === null || _d === void 0 ? void 0 : _d.getAttribute("data-node-id"),
                parentID: ((_e = newSourceElement.parentElement) === null || _e === void 0 ? void 0 : _e.getAttribute("data-node-id")) || protyle.block.parentID
            });
        }
        sourceElements.reverse().forEach((item, index) => {
            ...
            undoOperations.push({
                ...
                previousID: (_a = item.previousElementSibling) === null || _a === void 0 ? void 0 : _a.getAttribute("data-node-id"),
    ...
    if (topSourceElement) {
        ...
        undoOperations.splice(0, 0, {
            ...
            id: topSourceElement.getAttribute("data-node-id"),
            previousID: (_f = topSourceElement.previousElementSibling) === null || _f === void 0 ? void 0 : _f.getAttribute("data-node-id"),
            parentID: ((_g = topSourceElement.parentElement) === null || _g === void 0 ? void 0 : _g.getAttribute("data-node-id")) || protyle.block.parentID
        });
        if (!isSameDoc) {
            // 打开两个相同的文档
...
const dragSame = (protyle, sourceElements, targetElement, isBottom) => {
    var _a, _b, _c, _d;
    const isSameDoc = protyle.element.contains(sourceElements[0]);
    const doOperations = [];
    const undoOperations = [];
    ...
    if (isBottom) {
        ...
        if (newSourceElement) {
            ...
            doOperations.push({
                ...
                data: newSourceElement.outerHTML,
                id: newSourceElement.getAttribute("data-node-id"),
                previousID: (_a = newSourceElement.previousElementSibling) === null || _a === void 0 ? void 0 : _a.getAttribute("data-node-id"),
                parentID: ((_b = newSourceElement.parentElement) === null || _b === void 0 ? void 0 : _b.getAttribute("data-node-id")) || protyle.block.parentID
            });
            sourceElements.reverse().forEach((item, index) => {
                var _a;
                if (index === sourceElements.length - 1) {
            ...
            sourceElements.forEach((item, index) => {
                ...
                doOperations.push({
                    action: "move",
                    id: item.getAttribute("data-node-id"),
                    previousID: (_b = item.previousElementSibling) === null || _b === void 0 ? void 0 : _b.getAttribute("data-node-id"),
                    parentID: ((_c = item.parentElement) === null || _c === void 0 ? void 0 : _c.getAttribute("data-node-id")) || protyle.block.parentID
                });
            });
            undoOperations.reverse();
        }
    ...
    if (topSourceElement) {
        ...
        undoOperations.splice(0, 0, {
            ...
            data: topSourceElement.outerHTML,
            id: topSourceElement.getAttribute("data-node-id"),
            previousID: (_c = topSourceElement.previousElementSibling) === null || _c === void 0 ? void 0 : _c.getAttribute("data-node-id"),
            parentID: ((_d = topSourceElement.parentElement) === null || _d === void 0 ? void 0 : _d.getAttribute("data-node-id")) || protyle.block.parentID
        });
        oldSourceParentElement = topSourceElement.parentElement;
        topSourceElement.remove();
        if (!isSameDoc) {
...
export const dropEvent = (protyle, editorElement) => {
    ...
    editorElement.addEventListener("drop", (event) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        ...
        const isBacklink = ((_a = window.siyuan.dragElement) === null || _a === void 0 ? void 0 : _a.getAttribute("data-treetype")) === "backlink";
        if (window.siyuan.dragElement && targetElement && (window.siyuan.dragElement.parentElement.classList.contains("protyle-gutters") ||
            isBacklink ||
            ...
            if (isBacklink) {
                ...
                const domHTML = yield fetchSyncPost("/api/block/getBlockDOM", { id: sourceId });
                sourceElement.innerHTML = domHTML.data.dom;
                sourceElement = sourceElement.firstElementChild;
    ...
    editorElement.addEventListener("dragover", (event) => {
        ...
        if (window.siyuan.dragElement.parentElement.classList.contains("protyle-gutters") ||
            ...
            const selectedIdsData = window.siyuan.dragElement.getAttribute("data-selected-ids");
            const selectedIds = selectedIdsData ? selectedIdsData.split(",") : [window.siyuan.dragElement.getAttribute("data-node-id")];
            const isSelf = selectedIds.find((item) => {
    ...
    editorElement.addEventListener("dragleave", (event) => {
        ...
        if (nodeElement) {
            if ((((_a = window.siyuan.dragElement) === null || _a === void 0 ? void 0 : _a.getAttribute("data-selected-ids")) || "").indexOf(nodeElement.getAttribute("data-node-id")) === -1) {
