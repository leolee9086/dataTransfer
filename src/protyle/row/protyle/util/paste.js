...
export const paste = (protyle, event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!textHTML && !textPlain && ("clipboardData" in event) && "darwin" !== window.siyuan.config.system.os) {
        const xmlString = yield fetchSyncPost("/api/clipboard/readFilePaths", {});
    ...
    if (nodeElement.getAttribute("data-type") === "NodeCodeBlock") {
        ...
        if (!code.startsWith('<div data-type="NodeCodeBlock" class="code-block" data-node-id="')) {
            ...
            const codeElement = nodeElement.nextElementSibling;
            transaction(protyle, [{
                    action: "insert",
