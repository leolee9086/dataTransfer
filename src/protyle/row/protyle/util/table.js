...
export const deleteColumn = (protyle, range, nodeElement, cellElement) => {
    ...
    (_a = nodeElement.querySelectorAll("col")[index]) === null || _a === void 0 ? void 0 : _a.remove();
    updateTransaction(protyle, nodeElement.getAttribute("data-node-id"), nodeElement.outerHTML, html);
    focusByWbr(nodeElement, range);
};
...
export const fixTable = (protyle, event, range) => {
    ...
    if (event.key === "ArrowUp" && !isCtrl(event) && !event.shiftKey && !event.altKey) {
        ...
        if (startContainer.nodeType !== 3 && (startContainer.tagName === "TH" || startContainer.tagName === "TD")) {
            previousBrElement = (_a = startContainer.childNodes[Math.max(0, range.startOffset - 1)]) === null || _a === void 0 ? void 0 : _a.previousElementSibling;
        }
        else {
        ...
        if (!previousElement || (previousElement === null || previousElement === void 0 ? void 0 : previousElement.tagName) === "COL") {
            return false;
        }
    ...
    if (event.key === "ArrowDown" && !isCtrl(event) && !event.shiftKey && !event.altKey) {
        ...
        if (endContainer.nodeType !== 3 && (endContainer.tagName === "TH" || endContainer.tagName === "TD")) {
            nextBrElement = (_b = endContainer.childNodes[Math.max(0, range.endOffset - 1)]) === null || _b === void 0 ? void 0 : _b.nextElementSibling;
        }
        else {
    ...
    if (!nextRowElement && cellElement.parentElement.parentElement.tagName === "THEAD") {
        nextRowElement = (_c = tableElement.querySelector("tbody")) === null || _c === void 0 ? void 0 : _c.firstElementChild;
    }
    if (nextRowElement) {
