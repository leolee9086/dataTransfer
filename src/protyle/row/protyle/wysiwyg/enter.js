...
const listEnter = (protyle, blockElement, range) => {
    ...
    ["", "\n"].includes(editableElement.textContent) &&
        ...
        if ((_a = listItemElement.nextElementSibling) === null || _a === void 0 ? void 0 : _a.classList.contains("protyle-attr")) {
    ...
    if (((_b = editableElement === null || editableElement === void 0 ? void 0 : editableElement.lastElementChild) === null || _b === void 0 ? void 0 : _b.getAttribute("data-type")) === "inline-math" &&
        !hasNextSibling(editableElement === null || editableElement === void 0 ? void 0 : editableElement.lastElementChild)) {
...
export const enter = (blockElement, range, protyle) => {
    ...
    if (blockElement.parentElement.getAttribute("data-type") === "NodeListItem" &&
        (blockElement.nextElementSibling.classList.contains("protyle-attr") ||
            (blockElement.nextElementSibling.classList.contains("list") && ((_a = blockElement.previousElementSibling) === null || _a === void 0 ? void 0 : _a.classList.contains("protyle-action"))) ||
