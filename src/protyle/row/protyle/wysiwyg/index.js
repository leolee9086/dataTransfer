...
import { focusBlock, focusByRange, focusByWbr, focusSideBlock, getEditorRange, getSelectionOffset, } from "../util/selection";
...
import { getContenteditableElement, getLastBlock, getPreviousHeading, getTopAloneElement, hasNextSibling, isNotEditBlock } from "./getBlock";
    ...
    bindEvent(protyle) {
            ...
            if (selectElements.length > 0) {
                ...
                if (headElement && range.toString() === headElement.firstElementChild.textContent) {
                    ...
                    const undoOperations = [{
                            ...
                            previousID: (_a = headElement.previousElementSibling) === null || _a === void 0 ? void 0 : _a.getAttribute("data-node-id"),
                            parentID: ((_b = headElement.parentElement) === null || _b === void 0 ? void 0 : _b.getAttribute("data-node-id")) || protyle.block.parentID
                        }];
        ...
        this.element.addEventListener("contextmenu", (event) => {
            ...
            if (type === "a") {
                ...
                const rect = target.getBoundingClientRect();
                setPosition(window.siyuan.menus.menu.element, rect.left, rect.top + 13, 26);
                if ((_a = target.getAttribute("data-href")) === null || _a === void 0 ? void 0 : _a.startsWith("siyuan://blocks")) {
                    // 阻止 popover
            ...
            if (!isNotEditBlock(nodeElement) &&
                ...
                if (!isMobile() || ((_b = protyle.toolbar) === null || _b === void 0 ? void 0 : _b.element.classList.contains("fn__none"))) {
                    contentMenu(protyle, nodeElement);
                    window.siyuan.menus.menu.element.classList.remove("fn__none");
                    setPosition(window.siyuan.menus.menu.element, event.clientX, event.clientY + 13, 26);
                    (_c = protyle.toolbar) === null || _c === void 0 ? void 0 : _c.element.classList.add("fn__none");
                }
            }
                ...
                window.siyuan.menus.menu.element.classList.remove("fn__none");
                setPosition(window.siyuan.menus.menu.element, event.clientX, event.clientY);
                (_d = protyle.toolbar) === null || _d === void 0 ? void 0 : _d.element.classList.add("fn__none");
            }
        });
        ...
        this.element.addEventListener("mousewheel", (event) => {
            ...
            if (tableElement) {
                ...
                if (tableSelectElement === null || tableSelectElement === void 0 ? void 0 : tableSelectElement.style.width) {
        ...
        this.element.addEventListener("mousedown", (event) => {
            ...
            if (target.tagName === "TH" || target.tagName === "TD" || ((_a = target.firstElementChild) === null || _a === void 0 ? void 0 : _a.tagName) === "TABLE" || target.classList.contains("table__resize") || target.classList.contains("table__select")) {
            ...
            if (target.classList.contains("table__resize")) {
                ...
                // 兼容 1.8.2
                nodeElement.querySelectorAll("table th")[parseInt(target.getAttribute("data-col-index"))].style.width = "";
