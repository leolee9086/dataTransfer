...
export const input = (protyle, blockElement, range, needRender = true) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    ...
    if (brElement && brElement.parentElement.tagName !== "TD" && brElement.parentElement.tagName !== "TH" && (brElement.parentElement.textContent.trim() === "" ||
        ((_b = (_a = brElement.previousSibling) === null || _a === void 0 ? void 0 : _a.previousSibling) === null || _b === void 0 ? void 0 : _b.textContent) === "\n")) {
        brElement.remove();
    }
    ...
    if (refElement && refElement.getAttribute("data-subtype") === "d") {
        const response = yield fetchSyncPost("/api/block/getRefText", { id: refElement.getAttribute("data-id") });
    ...
    if (needRender && (((_c = getContenteditableElement(tempElement.content.firstElementChild)) === null || _c === void 0 ? void 0 : _c.innerHTML) !== getContenteditableElement(blockElement).innerHTML ||
        // 内容删空后使用上下键，光标无法到达 https://github.com/siyuan-note/siyuan/issues/4167 https://ld246.com/article/1636256333803
        tempElement.content.childElementCount === 1 && ((_d = getContenteditableElement(tempElement.content.firstElementChild)) === null || _d === void 0 ? void 0 : _d.innerHTML) === "<wbr>") &&
    ...
    Array.from(tempElement.content.children).forEach((item, index) => {
        ...
        if (tempId === id) {
            ...
            doOperations.push({
                ...
                data: item.outerHTML,
                id: tempId,
                previousID: index === 0 ? (_a = firstElement === null || firstElement === void 0 ? void 0 : firstElement.previousElementSibling) === null || _a === void 0 ? void 0 : _a.getAttribute("data-node-id") : item.previousElementSibling.getAttribute("data-node-id"),
                parentID: (firstElement === null || firstElement === void 0 ? void 0 : firstElement.parentElement.getAttribute("data-node-id")) || protyle.block.parentID
            });
            undoOperations.push({
                id: tempId,
                action: "delete"
