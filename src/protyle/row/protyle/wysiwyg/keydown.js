...
import { focusBlock, focusByRange, focusByWbr, getEditorRange, getSelectionOffset, selectAll, setFirstNodeRange, setLastNodeRange } from "../util/selection";
import { hasClosestBlock, hasClosestByAttribute, hasClosestByMatchTag, hasTopClosestByAttribute } from "../util/hasClosest";
    ...
    editorElement.addEventListener("keydown", (event) => {
        ...
        if (matchHotKey(window.siyuan.config.keymap.general.enter.custom, event)) {
            ...
            if (topNodeElement.parentElement.classList.contains("li") && topNodeElement.parentElement.parentElement.classList.contains("list") &&
                ((_a = topNodeElement.nextElementSibling) === null || _a === void 0 ? void 0 : _a.classList.contains("list")) && topNodeElement.previousElementSibling.classList.contains("protyle-action")) {
        ...
        if (!event.altKey && !event.shiftKey && !isCtrl(event) && !event.isComposing && (event.key.indexOf("Arrow") > -1)) {
            ...
            if (event.key === "ArrowDown" && ((_b = getContenteditableElement(nodeElement)) === null || _b === void 0 ? void 0 : _b.textContent.trimRight().substr(position.start).indexOf("\n")) === -1 && ((tdElement && !tdElement.parentElement.nextElementSibling && nodeElement.getAttribute("data-type") === "NodeTable" && !getNextBlock(nodeElement)) ||
                ...
                if ((!getPreviousBlock(nodeElement) && // 列表第一个块为嵌入块，第二个块为段落块，上键应选中第一个块 https://ld246.com/article/1652667912155
                    ...
                    if (previousElement) {
                        previousElement = getLastBlock(previousElement);
                        if (previousElement) {
                            previousElement = hasClosestByAttribute(previousElement, "fold", "1");
            ...
            if (protyle.wysiwyg.element.querySelector(".protyle-wysiwyg--select")) {
                ...
                if (event.key === "Delete") {
                    ...
                    if (range.startContainer.nodeType !== 3 &&
                        ...
                        ((_c = range.startContainer.children[range.startOffset - 1]) === null || _c === void 0 ? void 0 : _c.tagName) === "TABLE") {
                        nodeElement.classList.add("protyle-wysiwyg--select");
                        removeBlock(protyle, nodeElement, range);
                        event.stopPropagation();
                        event.preventDefault();
        ...
        if (matchHotKey(window.siyuan.config.keymap.editor.general.alignLeft.custom, event)) {
            ...
            actionElement.querySelectorAll(".img").forEach((item) => {
                item.style.display = "";
            });
        ...
        if (matchHotKey(window.siyuan.config.keymap.editor.general.moveToUp.custom, event)) {
            ...
            if (sourceElements.length === 0) {
                ...
                if ((_d = sourceElement.previousElementSibling) === null || _d === void 0 ? void 0 : _d.classList.contains("protyle-action")) {
            ...
            if (type === "NodeListItem" &&
                ...
                ((_f = (_e = sourceElements[0].parentElement.previousElementSibling) === null || _e === void 0 ? void 0 : _e.previousElementSibling) === null || _f === void 0 ? void 0 : _f.classList.contains("protyle-action"))) {
                if ((_g = sourceElements[0].parentElement.parentElement.previousElementSibling) === null || _g === void 0 ? void 0 : _g.classList.contains("li")) {
            ...
            if (type === "NodeList" &&
                ((_j = (_h = sourceElements[0].previousElementSibling) === null || _h === void 0 ? void 0 : _h.previousElementSibling) === null || _j === void 0 ? void 0 : _j.classList.contains("protyle-action"))) {
                if ((_k = sourceElements[0].parentElement.previousElementSibling) === null || _k === void 0 ? void 0 : _k.classList.contains("li")) {
            ...
            if (!sourceElements[0].previousElementSibling || ((_l = sourceElements[0].previousElementSibling) === null || _l === void 0 ? void 0 : _l.classList.contains("protyle-action"))) {
                return;
            }
            ...
            if (sourceElements[0].getAttribute("data-subtype") === "o" && type === "NodeListItem") {
                ...
                transaction(protyle, [{
                        ...
                        action: "move",
                        id,
                        previousID: (_m = previousElement.previousElementSibling) === null || _m === void 0 ? void 0 : _m.getAttribute("data-node-id"),
        ...
        if (matchHotKey(window.siyuan.config.keymap.editor.general.moveToDown.custom, event)) {
            ...
            if (sourceElements.length === 0) {
                ...
                if ((_o = sourceElement.previousElementSibling) === null || _o === void 0 ? void 0 : _o.classList.contains("protyle-action")) {
                    sourceElement = getTopAloneElement(sourceElement.parentElement);
                }
                sourceElements = [sourceElement];
            }
            ...
            if (type === "NodeListItem" &&
                ...
                ((_p = sourceElements[0].parentElement.parentElement) === null || _p === void 0 ? void 0 : _p.classList.contains("li"))) {
                if ((_q = sourceElements[0].parentElement.parentElement.nextElementSibling) === null || _q === void 0 ? void 0 : _q.classList.contains("li")) {
            ...
            if (type === "NodeList" && sourceElements[sourceElements.length - 1].nextElementSibling.classList.contains("protyle-attr") &&
                ((_r = sourceElements[0].parentElement) === null || _r === void 0 ? void 0 : _r.classList.contains("li"))) {
                if ((_s = sourceElements[0].parentElement.nextElementSibling) === null || _s === void 0 ? void 0 : _s.classList.contains("li")) {
            ...
            if (!sourceElements[sourceElements.length - 1].nextElementSibling || ((_t = sourceElements[sourceElements.length - 1].nextElementSibling) === null || _t === void 0 ? void 0 : _t.classList.contains("protyle-attr"))) {
                return;
            }
            ...
            if (nextElement.getAttribute("data-subtype") === "o" && nextElement.getAttribute("data-type") === "NodeListItem") {
                ...
                transaction(protyle, [{
                        action: "move",
                        id,
                        previousID: (_u = sourceElements[0].previousElementSibling) === null || _u === void 0 ? void 0 : _u.getAttribute("data-node-id"),
