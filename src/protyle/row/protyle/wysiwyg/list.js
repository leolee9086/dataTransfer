...
export const breakList = (protyle, blockElement, range) => {
    ...
    if (listItemElement.parentElement.childElementCount === 2) {
        undoOperations.splice(0, 0, {
            ...
            previousID: (_a = listItemElement.parentElement.previousElementSibling) === null || _a === void 0 ? void 0 : _a.getAttribute("data-node-id"),
        ...
        undoOperations.splice(0, 0, {
            ...
            previousID: (_b = listItemElement.previousElementSibling) === null || _b === void 0 ? void 0 : _b.getAttribute("data-node-id"),
            parentID: parentId
        });
...
export const listOutdent = (protyle, liItemElements, range) => {
    ...
    if (parentLiItemElement.classList.contains("protyle-wysiwyg") || parentLiItemElement.classList.contains("sb") || parentLiItemElement.classList.contains("bq")) {
        ...
        if (liElement.childElementCount === 1) {
            ...
            undoOperations.splice(0, 0, {
                ...
                data: movedHTML,
                id: liId,
                previousID: (_a = liElement.previousElementSibling) === null || _a === void 0 ? void 0 : _a.getAttribute("data-node-id"),
                parentID: parentLiItemElement.getAttribute("data-node-id") || protyle.block.parentID
            });
            liElement.remove();
        }
    ...
    const doOperations = [];
    const undoOperations = [];
    const previousID = (_b = liItemElements[0].previousElementSibling) === null || _b === void 0 ? void 0 : _b.getAttribute("data-node-id");
    liItemElements.forEach(item => {
        item.classList.remove("protyle-wysiwyg--select");
    });
    let startIndex;
