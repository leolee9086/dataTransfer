    ...
    if (!blockElement.parentElement.previousElementSibling) {
        ...
        Array.from(tempElement.children).forEach((item, index) => {
            ...
            doOperations.push({
                ...
                data: item.outerHTML,
                previousID: index === 0 ? (_a = listElement.previousElementSibling) === null || _a === void 0 ? void 0 : _a.getAttribute("data-node-id") : doOperations[index - 1].id,
...
export const removeBlock = (protyle, blockElement, range) => {
    ...
    if ((selectElements === null || selectElements === void 0 ? void 0 : selectElements.length) > 0) {
        const deletes = [];
        const inserts = [];
    ...
    if (!blockElement.previousElementSibling && blockElement.parentElement.getAttribute("data-type") === "NodeBlockquote") {
        ...
        if (blockParentElement.childElementCount === 1) {
            transaction(protyle, [{
                    ...
                    previousID: (_a = blockElement.previousElementSibling) === null || _a === void 0 ? void 0 : _a.getAttribute("data-node-id"),
                    ...
                    previousID: (_b = blockElement.previousElementSibling) === null || _b === void 0 ? void 0 : _b.getAttribute("data-node-id"),
                    parentID: blockParentElement.parentElement.getAttribute("data-node-id") || protyle.block.parentID
                }, {
                    action: "move",
                    id: blockElement.getAttribute("data-node-id"),
            ...
            transaction(protyle, [{
                    action: "move",
                    id: blockElement.getAttribute("data-node-id"),
                    previousID: (_c = blockElement.previousElementSibling) === null || _c === void 0 ? void 0 : _c.getAttribute("data-node-id"),
                    parentID: blockParentElement.parentElement.getAttribute("data-node-id") || protyle.block.parentID
                }], [{
                    action: "move",
                    id: blockElement.getAttribute("data-node-id"),
        ...
        if (previousLastElement.classList.contains("code-block")) {
            if (editableElement.textContent.trim() === "") {
                ...
                const undoOperations = [{
                        ...
                        id: id,
                        previousID: (_d = blockElement.previousElementSibling) === null || _d === void 0 ? void 0 : _d.getAttribute("data-node-id"),
    ...
    const undoOperations = [{
            ...
            previousID: (_e = blockElement.previousElementSibling) === null || _e === void 0 ? void 0 : _e.getAttribute("data-node-id"),
    ...
    if (isSelectNode) {
        ...
        if (editableElement.textContent !== "") {
            ...
            if (((_f = previousLastEditElement === null || previousLastEditElement === void 0 ? void 0 : previousLastEditElement.lastElementChild) === null || _f === void 0 ? void 0 : _f.getAttribute("data-type")) === "inline-math") {
                const lastSibling = hasNextSibling(previousLastEditElement === null || previousLastEditElement === void 0 ? void 0 : previousLastEditElement.lastElementChild);
