    ...
    if (operation.action === "move") {
        ...
        if (!updateElement) {
            ...
            getAllModels().editor.forEach(editor => {
                ...
                if (updateCloneElement) {
                    updateElement = updateCloneElement.cloneNode(true);
                }
            });
        }
        if (operation.previousID) {
            ...
            if (parentElement && updateElement) {
                // 列表特殊处理
                if ((_a = parentElement.firstElementChild) === null || _a === void 0 ? void 0 : _a.classList.contains("protyle-action")) {
    ...
    if (operation.action === "insert") {
        ...
        if (operation.previousID) {
            ...
            if (beforeElement) {
                ...
                cursorElement = beforeElement.nextElementSibling;
            }
        }
        else {
            let parentElement;
            ...
            if (parentElement) {
                // 列表特殊处理
                if ((_b = parentElement.firstElementChild) === null || _b === void 0 ? void 0 : _b.classList.contains("protyle-action")) {
                    parentElement.firstElementChild.insertAdjacentHTML("afterend", operation.data);
                    cursorElement = parentElement.firstElementChild.nextElementSibling;
                }
                else {
                    parentElement.insertAdjacentHTML("afterbegin", operation.data);
                    cursorElement = parentElement.firstElementChild;
                }
            }
            else if (operation.parentID === protyle.block.parentID) {
                protyle.wysiwyg.element.insertAdjacentHTML("afterbegin", operation.data);
                cursorElement = protyle.wysiwyg.element.firstElementChild;
            }
        }
        if (!cursorElement) {
            return;
...
export const turnIntoTransaction = (options) => __awaiter(void 0, void 0, void 0, function* () {
    var e_1, _a;
    var _b, _c;
    if (!options.nodeElement.querySelector("wbr")) {
        (_b = getContenteditableElement(options.nodeElement)) === null || _b === void 0 ? void 0 : _b.insertAdjacentHTML("afterbegin", "<wbr>");
    }
    ...
    if (options.type === "CancelList" || options.type === "CancelBlockquote") {
        try {
            for (var _d = __asyncValues(options.nodeElement.querySelectorAll('[data-type="NodeHeading"][fold="1"]')), _e; _e = yield _d.next(), !_e.done;) {
                const item = _e.value;
                const itemId = item.getAttribute("data-node-id");
                item.removeAttribute("fold");
                const response = yield fetchSyncPost("/api/transactions", {
    ...
    const previousId = (_c = options.nodeElement.previousElementSibling) === null || _c === void 0 ? void 0 : _c.getAttribute("data-node-id");
...
export const phTransaction = (protyle, range, nodeElement, level) => {
